        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "- The FIRST WORD of EVERY response MUST be either 'Correct!' or "
                    "'Not quite.' — NO other opening word is allowed. NEVER say "
                    "'Great', 'Good', 'Awesome', 'Well done', 'Excellent', or ANY "
                    "other word before the judgment.\n"
                    "- STEP 1: ALWAYS judge first. Say EXACTLY 'Correct!' or 'Not quite.'\n"
                    "- STEP 2: THEN announce the next word.\n"
                    "- STEP 3: STOP. Say nothing else.\n"
                    "- VALID: 'Correct! Your next word is calendar.'\n"
                    "- VALID: 'Not quite. Your next word is calendar.'\n"
                    "- INVALID: 'Great! ...' (WRONG — do NOT use 'Great')\n"
                    "- INVALID: 'Well done! ...' (WRONG — do NOT use 'Well done')\n"
                    "- INVALID: 'The child spelled X correctly.' (WRONG — NEVER narrate)\n"
                    "- INVALID: 'Your next word is calendar.' (WRONG — MISSING JUDGMENT)\n"
                    "- NEVER narrate or describe what happened. NEVER say 'The child "
                    "spelled...' or 'You spelled...'. Just judge and move on.\n"
