        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "BE GENEROUS: ASR often garbles letters. If the assembled letters are "
                    "CLOSE to the target word (e.g. missing one letter, extra letter, or "
                    "a letter sounds similar), count it as CORRECT.\n"
